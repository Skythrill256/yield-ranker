[33mfdc9c19[m[33m ([m[1;36mHEAD -> [m[1;32mmain[m[33m, [m[1;31morigin/main[m[33m)[m add 5Y, 10Y, 15Y total returns to refresh_all script database updates
[33m7ec1b1c[m fix Z-score calculation to use adj_close prices like Python example
[33m0f7387b[m calculate Z-score, NAV trend 6M, and NAV return 12M in real-time with proper formulas
